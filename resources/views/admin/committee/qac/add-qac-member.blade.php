...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">In Add QAC Member</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            @endif
            <div class="well">
                <form class="form-horizontal" action="{{ url('/committee/qac/new-qac-member') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9">
                            <button type="submit" name="btn" class="btn btn-success btn-block">Add QAC Member</button>
                        </div>
                    </div>
                </form>
            </div>

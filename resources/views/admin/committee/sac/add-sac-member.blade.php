...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">In Add SAC Member</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            @endif
            <div class="well">
                <form class="form-horizontal" action="{{ url('/committee/sac/new-sac-member') }}" method="post">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="col-sm-3" style="padding-left: 0;">
                                <input type="text" name="sac_one_name" class="form-control" placeholder="Name">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="sac_one_mobile" class="form-control" placeholder="Mobile No">
                                <span class="text-danger">{{ $errors->has('sac_one_mobile') ? $errors->first('sac_one_mobile') : '' }}</span>
                            </div>
                            <div class="col-sm-3" style="padding-right: 0;">
                                <input type="text" name="sac_one_email" class="form-control" placeholder="Email">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="col-sm-3" style="padding-left: 0;">
                                <input type="text" name="sac_two_name" class="form-control" placeholder="Name">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="sac_two_mobile" class="form-control" placeholder="Mobile No">
                                <span class="text-danger">{{ $errors->has('sac_two_mobile') ? $errors->first('sac_two_mobile') : '' }}</span>
                            </div>
                            <div class="col-sm-3" style="padding-right: 0;">
                                <input type="text" name="sac_two_email" class="form-control" placeholder="Email">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="col-sm-3" style="padding-left: 0;">
                                <input type="text" name="sac_three_name" class="form-control" placeholder="Name">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="sac_three_mobile" class="form-control" placeholder="Mobile No">
                                <span class="text-danger">{{ $errors->has('sac_three_mobile') ? $errors->first('sac_three_mobile') : '' }}</span>
                            </div>
                            <div class="col-sm-3" style="padding-right: 0;">
                                <input type="text" name="sac_three_email" class="form-control" placeholder="Email">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="submit" name="btn" class="btn btn-success btn-block">Add SAC Member</button>
                        </div>
                    </div>
                </form>
            </div>

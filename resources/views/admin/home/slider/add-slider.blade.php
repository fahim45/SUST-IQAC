...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">In Add Slider</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            @endif
            <div class="well">
                <form class="form-horizontal" action="{{ url('/home/slider/new-slider') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="file" name="slider_photo" id="slider_photo" class="form-control" required>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9">
                            <button type="submit" name="btn" class="btn btn-success btn-block">Add Slider Photo</button>
                        </div>
                    </div>
                </form>
            </div>

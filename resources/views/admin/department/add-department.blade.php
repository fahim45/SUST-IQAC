...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">In Add Department</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            @endif
            <div class="well">
                <form class="form-horizontal" action="{{ url('/department/new-department') }}" method="post">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9">
                            <button type="submit" name="btn" class="btn btn-success btn-block">Add Department</button>
                        </div>
                    </div>
                </form>
            </div>

...
class SACMemberController extends Controller
{
    ...
    public function updateSACMemberInfo(Request $request){
        $this->validate($request,[
            'phase_no'=>'required',
            'department_id'=>'required',
            'sac_one_name'=>'required',
        ...
        $sacMembers = SACMember::find($request->sacmember_id);
        $sacMembers->phase_no = $request->phase_no;
        $sacMembers->department_id = $request->department_id;
        $sacMembers->sac_one_name = $request->sac_one_name;
        $sacMembers->sac_one_role = $request->sac_one_role;
        ...
        $sacMembers->publication_status = $request->publication_status;
        $sacMembers->save();
        return redirect('committee/sac/manage-sac-member')->with('message', 'SAC Members Info Updated Successfully');
    }
